        ...
        <div className="hero-container">
          ...
          <div className="hero-main">
            ...
            <p className="hero-description">
              ...
              Увеличьте продажи с автоматической поддержкой, персонализированными рекомендациями и умными взаи��одействиями.
            </p>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС анализирует поведение каждого клиента в реальном времени и предлагает именно те товары, которые им нужны. Он понимает предпочтения покупателей лучше, чем они сами, изучая их ��сторию покупок и поисковые запросы.
                  </p>
                </div>
              </div>

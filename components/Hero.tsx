            ...
            <div className="contract-panel-content">
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    Сначала мы создаем детальный м����кет вашего проекта. Это включает в себя дизайн всех страниц, структуру сайта и техническое задание. На этом этапе ��ы видите как будет выглядеть конечный результат.
                  </p>
                </div>
              </div>
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    Приступаем к программированию и созданию вашего про��кта. Макет корректируется и дорабатывается в процессе работы для достижения наилучшего результата. Мы не меняем макет по несколько раз без весомых оснований.
                  </p>
                </div>
              </div>
              ...
              <div className="contract-step">
                ...
                <div className="step-content">
                  <h3 className="step-title">Сдача проек��а</h3>
                  <p className="step-description">
            ...
            <div className="features-panel-content">
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС анализирует поведение каждого клиента в реальном времени и предлагает именно те товары, которые им нужны. Он понимает предпочтения покупателей лучше, чем они сами, изучая ��х историю покупок и поисковые запросы.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-content">
                  ...
                  <p className="feature-description">
                    ДЖАРВИС создает уникальный профиль каждого покупателя и предлагает това��ы, которые идеально подходят именно ему. Система учитывает сезон, праздники, предыдущие покупки и даже настроение клиента по его сообщениям.
                  </p>
                </div>
              </div>

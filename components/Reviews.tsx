...
const reviews = [
  ...
  },
  {
    id: 6,
    rating: 5,
    text: "Мой магазин ювелирных изделий стал более удобным благодаря Jarvis. Бот помогает к��иентам выбрать подходящие украшения и отвечает на все вопросы.",
    author: "Васильева О.",
  ...
  },
  {
    ...
    author: "Петрова М.",
    location: "Нижний Нов��ород, Freelance"
  },
  {
    id: 10,
    rating: 5,
